...
function VenusHttp(venus, config) {
  ...
  this.namespaces = {};
  this.config     = config || {};
  this.port       = this.config.get('plugins.venus-http.port') || 2013;
}
 ...
 * @property name
 */
VenusHttp.prototype.name = require(path.resolve(__dirname, '..', 'package.json')).name;

/**
 * @property version
 */
VenusHttp.prototype.version = require(path.resolve(__dirname, '..', 'package.json')).version;

/**
 * @property dependencies
 */
VenusHttp.prototype.dependencies = require(path.resolve(__dirname, '..', 'package.json')).venusDependencies;
...
VenusHttp.prototype.addNamespaceHandler = function (namespace, fn, ctx) {
  ...
  this.venus.debug('Added namespace handler for /' + namespace);
};
